...
# Verifica se o nome de usuário ja está em uso
...
# Efetua o login a partir da entrada de senha e usuario
def login():
    while True:
...
# Realiza o cadastro de um novo usuário e guarda as informações 
def cadastro():
    while True:
...
# Mostra o menu do site e redireciona o usuário dependendo 
def central_do_site():
    while True:
